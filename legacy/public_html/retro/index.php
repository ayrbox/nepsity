...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="<?php echo ROOT.DS.'layout'.DS.'css'.DS.'allinone_bannerWithPlaylist.css'?>">		
		...
		<script src="<?php echo ROOT.DS.'layout'.DS.'js'.DS ?>jquery.ui.touch-punch.min.js" type="text/javascript"></script>
		<script src="<?php echo ROOT.DS.'layout'.DS.'js'.DS ?>jquery.mousewheel.min.js" type="text/javascript"></script>
		<script src="<?php echo ROOT.DS.'layout'.DS.'js'.DS ?>allinone_bannerWithPlaylist.js" type="text/javascript"></script>		
		<script src="<?php echo ROOT.DS.'layout'.DS.'js'.DS ?>jquery.ns-calendar.js" type="text/javascript"></script>
		<script src="<?php echo ROOT.DS.'layout'.DS.'js'.DS ?>jquery.flip.min.js" type="text/javascript"></script>		
		<script src="<?php echo ROOT.DS.'layout'.DS.'js',DS ?>jquery.validation.js" type="text/javascript"></script>
		...
		<div class="pageWrapper">
			<div class="headerBar">
				<div class="headerWrapper">
					<div class="logoHolder"><a href="http://www.nepsity.com" id="logo" title="Nepsity.com"> </a></div>
					<div class="menuLeft">
						<ul>
			...
			<div class="bodyWrapper">
				...
				<div class="popularOrganisers"></div>
				<div class="hotEvents"></div>-->
					<?php echo $content; ?>
				</div> <!--mainContent div ends-->
